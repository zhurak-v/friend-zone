...
public class PromptCore : IPromptSimplePort, IPromptStreamingPort
{
    private IPromptSimplePort? _simpleGenerator;
    private IPromptStreamingPort? _streamingGenerator;

    public PromptCore(IPromptSimplePort? simpleGenerator = null, IPromptStreamingPort? streamingGenerator = null)
    {
